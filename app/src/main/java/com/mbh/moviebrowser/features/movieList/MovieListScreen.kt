...
fun MovieListScreenUIPreview() {
    MovieListScreenUI(
        ...
        onDetailsClicked = {},
        onBottomReached = {},
        resolveGenreList = { it.genrePreview ?: "N/A" },
    )
}
